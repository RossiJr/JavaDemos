...
import org.rossijr.authentication.exception.EmailAlreadyInUseException;
...
public class UserService {
     ...
     * @throws EmailAlreadyInUseException if the email is already associated with an existing user
     */
